...
public class ImplantedFangsVampiresWithInjectors : ImplantedFangs
{
    public override string Name { get { return "Вампиры c инжекторами"; } }

    public ImplantedFangsVampiresWithInjectors()
    {
